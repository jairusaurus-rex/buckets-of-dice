        ...
        <div className="p-2 text-justify">
            ...
            <div className="p-2">
                ...
                <p>
                    ...
                    week, the Empian were at war with the Drakari for hundreds of years.
                    As fold travel became more efficient, both sides realized that the war
                    would only become more and more catastrophic. With the help of the Feyra,
                    the war ended and the Star Alliance was formed.
                </p>
                <p className="pt-2">
            ...
            <div className="p-2">
                ...
                <p>
                    ...
                    three major players in its government, along with the Drakari and the
                    Velki, with whom they have a close relationship. They are widely seen
                    as leaders within the Star Alliance and are highly respected by its
                    members.
                </p>
                <p className="pt-2">
                    Humans and the Rhazak, however, tend to view the Empian with suspicion
                    because of their psionic abilities.
                </p>
            </div>
        </div>
    );
