    ...
    <div className={`p-2 text-justify `}>
      ...
      <ol className="list-decimal list-inside pl-4 space-y-2">
        <li><span className="font-bold text-lg">Set Starting Level</span>
          ...
          <p className=" p-2">For a new character joining an ongoing gain, the starting level 
            is either the average level of the current group (rounded up) or the lowest level in 
            the current group, whichever is lower</p>
        </li>
        <li><span className="font-bold text-lg">Set Stats</span>
          <p className=" p-2">Starting Stamina and Grit are at max, credits is equal to 25k times 
            starting level</p>
        </li>
        ...
        <li><span className="font-bold text-lg">Choose Species</span>
          <p className=" p-2">Choose a species for your characte. See Species 
            list <Link to={`/wiki/${WikiArticleLinks.SPECIES}`}>here</Link></p>
        </li>
        ...
        <li><span className="font-bold text-lg">Level Up Character</span>
          <p className=" p-2">Using the method in 
            the <Link to={`/wiki/${WikiArticleLinks.LEVELING}`}>Leveling page</Link>, level up your 
            character until you reach your starting level. Make sure to level up from the very 
            first level (level 0 to level 1). See page of 
            Leveling <Link to={`/wiki/${WikiArticleLinks.LEVELING}`}>here</Link>  </p>
        </li>
      </ol>
    </div>
  );
